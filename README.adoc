...
* https://youtu.be/0UxY0EEzB1c[Video Walkthrough]
...
* Use `<h1>` tags containing the major name followed by 3 sections, each
using `<section>` tags.
...
* Display 10 randomly selected comments from your database in a `<ul>`
